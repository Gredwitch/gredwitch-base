...
if  ( !self:CanPrimaryAttack() ) then return end
	...
	if SERVER then
		...
		if traceRes.Hit then
			spawnpos = traceRes.HitPos - Vector(0,-2000,64)
		else
		...
		if traceRes.Hit then
			bspawnpos = traceRes.HitPos - Vector(0,-1600,64)
		else
			bspawnpos = hitpos + Vector(0,-1600,1200)
		end
		
		local cspawnpos
		
		if traceRes.Hit then
			cspawnpos = traceRes.HitPos - Vector(0,-1200,64)
		else
			cspawnpos = hitpos + Vector(0,-1200,1200)
		end
		
		local dspawnpos
		
		if traceRes.Hit then
			dspawnpos = traceRes.HitPos - Vector(0,-800,64)
		else
			dspawnpos = hitpos + Vector(0,-800,1200)
		end
		
		local espawnpos
		
		if traceRes.Hit then
			espawnpos = traceRes.HitPos - Vector(0,-400,64)
		else
			espawnpos = hitpos + Vector(0,-400,1200)
		end
		
				local fspawnpos
		
		if traceRes.Hit then
			fspawnpos = traceRes.HitPos - Vector(0,0,64)
		else
			fspawnpos = hitpos + Vector(0,0,1200)
		end
		
				local gspawnpos
		
		if traceRes.Hit then
			gspawnpos = traceRes.HitPos - Vector(0,400,64)
		else
			gspawnpos = hitpos + Vector(0,400,1200)
		end
		
				local hspawnpos
		
		if traceRes.Hit then
			hspawnpos = traceRes.HitPos - Vector(0,800,64)
		else
			hspawnpos = hitpos + Vector(0,800,1200)
		end
		
				local ispawnpos
		
		if traceRes.Hit then
			ispawnpos = traceRes.HitPos - Vector(0,1200,64)
		else
			ispawnpos = hitpos + Vector(0,1200,1200)
		end
		
				local jspawnpos
		
		if traceRes.Hit then
			jspawnpos = traceRes.HitPos - Vector(0,1600,64)
		else
			jspawnpos = hitpos + Vector(0,1600,1200)
		end
		
			local kspawnpos
		
		if traceRes.Hit then
			kspawnpos = traceRes.HitPos - Vector(0,2000,64)
		else
			kspawnpos = hitpos + Vector(0,2000,1200)
		end
		
			local lspawnpos
		
		if traceRes.Hit then
			lspawnpos = traceRes.HitPos - Vector(0,2400,64)
		else
			lspawnpos = hitpos + Vector(0,2400,1200)
		end
		
			local mspawnpos
		
		if traceRes.Hit then
			mspawnpos = traceRes.HitPos - Vector(0,2800,64)
		else
			mspawnpos = hitpos + Vector(0,2800,1200)
		end
