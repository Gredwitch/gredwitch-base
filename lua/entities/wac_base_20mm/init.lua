...
ENT.Explode=function(self,tr)
	...
	if !tr.HitSky then
		...
		explode:SetKeyValue("radius", self.Radius*3.5)
		explode:Fire("Explode", 0, 0)
		--timer.Simple(1,function() explode:Remove() end)
		self.Owner = self.Owner or self.Entity
		util.BlastDamage(self, self.Owner, tr.HitPos, self.Radius, self.Damage)
		--[[ParticleEffect("doi_gunrun_impact",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("30cal_impact_sparks_b",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("30cal_impact_spikes",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("30cal_impact_flash",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_shockwave",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_smoketrails",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_sparkTrail_b",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_debris_d",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_flash_b",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_flames",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_spikes",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_sparkTrail",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_spikes_c",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_spikes",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_sparks",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_debris_small",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_spikes_b",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("doi_grenade_explosion_debris",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)
		ParticleEffect("generic_crater_smoke",tr.HitPos,Angle(tr.HitNormal:Angle(),0,0),nil)--]]
