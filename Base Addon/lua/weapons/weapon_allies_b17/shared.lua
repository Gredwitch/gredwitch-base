...
if  ( !self:CanPrimaryAttack() ) then return end
	...
	self.Weapon:EmitSound("/radio/allied/carpetbombbegin"..(math.random(1,5))..".ogg")
	...
	if SERVER then
		...
		ArtiStrike.ShellType		= "gb_bomb_250gp"
		ArtiStrike.Delay	    	= self.strikedalay
		ArtiStrike.ShellCount		= 14
		ArtiStrike.Owner			= self.Owner
		ArtiStrike.Team				= "Allied"
		ArtiStrike.StrikeString 	= "Air"
		ArtiStrike.Bomber			= true
		ArtiStrike.CallAng			= self.Owner:GetAngles().y
		ArtiStrike:Spawn()
		ArtiStrike:Activate()	
	end
end