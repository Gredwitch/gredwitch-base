     ...
     if(self:WaterLevel() >= 1) then
		...
		if self.WaterFarExplosionSound == nil then else  
		 ...
		 if trace.HitWorld then
		    if self.Effect == "doi_artillery_explosion" or self.Effect == "doi_stuka_explosion" or self.Effect == "ins_rpg_explosion" or self.Effect == "doi_mortar_explosion" or "ins_c4_explosion" then 
		    ...
		    if self.EffectAir == "doi_artillery_explosion" or self.EffectAir == "doi_stuka_explosion" or self.EffectAir == "ins_rpg_explosion" or self.EffectAir == "doi_mortar_explosion"  or "ins_c4_explosion" then 
